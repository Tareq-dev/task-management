...
function AllTask() {
  ...
  useEffect(() => {
    // firebase.listAllTasks().then((tasks) => setTasks(tasks.docs));
  }, []);
          ...
          {tasks.map((task) => (
            <div key={task.id}>
              <div className="p-4 bg-white my-2 rounded-md shadow">
                ...
                <h5 className="text-xl font-bold py-1">{task.data().title}</h5>
                <p className="py-2">{task.data().description}</p>
