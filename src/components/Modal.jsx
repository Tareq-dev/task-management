  ...
  return (
    <div className={modalClasses}>
      ...
      <div className="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
        <div className="modal-content py-4 text-left px-3">
          <div className="flex justify-between items-center pb-1">
            ...
            <button
              onClick={onClose}
              className="modal-close cursor-pointer z-50 p-1 rounded-full bg-purple-500 border border-black w-15 h-15"
            >
              <svg
          ...
          <form onSubmit={handleSubmit} className="mt-4">
            <div className="flex justify-between gap-2 mb-1">
              <div className="mb-1">
                ...
                <input
                  ...
                  className="border border-gray-300 rounded px-1 py-1 w-32"
                />
              </div>
              <div className="mb-1">
                <label
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="border border-gray-300 rounded px-2 py-[5px] w-[140px]"
                />
              </div>
            </div>
            <div className="mb-2">
            ...
            <div className="mb-1 flex items-center">
              ...
              <select
                ...
                onChange={handleChange}
                className="px-4 py-1 border rounded-lg ml-2"
              >
